        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              ...
              Text("SGems",style: TextStyle(fontFamily: "Raleway",fontWeight: FontWeight.w700,fontSize: 20,color: Colors.white),),
            ],
          ),
          Container(
            margin: EdgeInsets.only(top: 30),
            child:Text("Total Gems Points",textAlign: TextAlign.center,style: TextStyle(fontFamily: "Raleway",fontWeight: FontWeight.w700,fontSize: 18,color: Colors.white),),
          ),
          StreamBuilder(
